...
public class Localization extends LocalizationEnum {
    ...
    public static final Localization COMMAND_DESTEDIT_ADDMEMBER_SUCCESS = new Localization("command.destedit.addmember.success", "<prefix/><green>Du hast</green> <yellow>{player}</yellow> <green>als Besitzer des Fahrziel</green> <yellow>{destination}</yellow> <green>hinzugefügt.</green>");
    public static final Localization COMMAND_DESTEDIT_ADDMEMBER_FAILED = new Localization("command.destedit.addmember.failed", "<prefix/><yellow>{input}</yellow> <red>ist bereits als Besitzer des Fahrziel</red> <yellow>{destination}</yellow> <red>eingetragen.</red>");
    public static final Localization COMMAND_DESTEDIT_REMOVEMEMBER_SUCCESS = new Localization("command.destedit.removemember.success", "<prefix/><green>Du hast</green> <yellow>{player}</yellow> <green>als Besitzer des Fahrziel</green> <yellow>{destination}</yellow> <green>entfernt.</green>");
    public static final Localization COMMAND_DESTEDIT_REMOVEMEMBER_FAILED = new Localization("command.destedit.removemember.failed", "<prefix/><yellow>{input}</yellow> <red>ist nicht als Besitzer des Fahrziel</red> <yellow>{destination}</yellow> <red>eingetragen.</red>");
